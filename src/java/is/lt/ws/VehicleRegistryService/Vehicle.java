...
public class Vehicle  implements java.io.Serializable {
    ...
    private is.lt.ws.VehicleRegistryService.Technical technical;

    private is.lt.ws.VehicleRegistryService.Owner[] owners;

    private is.lt.ws.VehicleRegistryService.Operator[] operators;

    private is.lt.ws.VehicleRegistryService.Plate[] plates;

    private is.lt.ws.VehicleRegistryService.Disaster[] disasters;

    private is.lt.ws.VehicleRegistryService.Registration[] registrations;

    private is.lt.ws.VehicleRegistryService.OutOfUse[] outofuses;

    private is.lt.ws.VehicleRegistryService.Updatelock[] updatelocks;

    private is.lt.ws.VehicleRegistryService.Stolen[] stolens;

    private is.lt.ws.VehicleRegistryService.Remark[] remarks;

    private is.lt.ws.VehicleRegistryService.Inspection[] inspections;

    private is.lt.ws.VehicleRegistryService.OwnerRegistrationError[] ownerRegistrationErrors;

    private is.lt.ws.VehicleRegistryService.VehicleChange[] vehicleChanges;

    private is.lt.ws.VehicleRegistryService.TypeChange[] typeChanges;

    private is.lt.ws.VehicleRegistryService.SpecialEquipmentChange[] specialEquipmentChanges;

    private is.lt.ws.VehicleRegistryService.AddonsChange[] addonsChanges;

    private is.lt.ws.VehicleRegistryService.SuperstructureChange[] superstructureChanges;

    private is.lt.ws.VehicleRegistryService.Adr[] adrs;
    ...
    public Vehicle(
           ...
           boolean rebuilt,
           boolean offroad,
           is.lt.ws.VehicleRegistryService.Technical technical,
           is.lt.ws.VehicleRegistryService.Owner[] owners,
           is.lt.ws.VehicleRegistryService.Operator[] operators,
           is.lt.ws.VehicleRegistryService.Plate[] plates,
           is.lt.ws.VehicleRegistryService.Disaster[] disasters,
           is.lt.ws.VehicleRegistryService.Registration[] registrations,
           is.lt.ws.VehicleRegistryService.OutOfUse[] outofuses,
           is.lt.ws.VehicleRegistryService.Updatelock[] updatelocks,
           is.lt.ws.VehicleRegistryService.Stolen[] stolens,
           is.lt.ws.VehicleRegistryService.Remark[] remarks,
           is.lt.ws.VehicleRegistryService.Inspection[] inspections,
           is.lt.ws.VehicleRegistryService.OwnerRegistrationError[] ownerRegistrationErrors,
           is.lt.ws.VehicleRegistryService.VehicleChange[] vehicleChanges,
           is.lt.ws.VehicleRegistryService.TypeChange[] typeChanges,
           is.lt.ws.VehicleRegistryService.SpecialEquipmentChange[] specialEquipmentChanges,
           is.lt.ws.VehicleRegistryService.AddonsChange[] addonsChanges,
