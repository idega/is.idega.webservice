...
public class VehicleExtra  implements java.io.Serializable {
    ...
    private is.idega.webservice.vehicleregistryservice.client.Wage wage;

    private is.idega.webservice.vehicleregistryservice.client.ExciseTax[] exciseTax;

    private java.lang.String exciseTaxes;

    private is.idega.webservice.vehicleregistryservice.client.TotalStatus totalStatus;

    private is.idega.webservice.vehicleregistryservice.client.Reading[] alestrar;

    private is.idega.webservice.vehicleregistryservice.client.EstimatedAutomobileTax estimatedAutomobileTaxes;
    ...
    public VehicleExtra(
           ...
           is.idega.webservice.vehicleregistryservice.client.Wage wage,
           is.idega.webservice.vehicleregistryservice.client.ExciseTax[] exciseTax,
     ...
     * @return wage
     */
    public is.idega.webservice.vehicleregistryservice.client.Wage getWage() {
        return wage;
    }
     ...
     * @param wage
     */
    public void setWage(is.idega.webservice.vehicleregistryservice.client.Wage wage) {
        this.wage = wage;
    }
     ...
     * @return exciseTax
     */
    public is.idega.webservice.vehicleregistryservice.client.ExciseTax[] getExciseTax() {
        return exciseTax;
    }
     ...
     * @param exciseTax
     */
    public void setExciseTax(is.idega.webservice.vehicleregistryservice.client.ExciseTax[] exciseTax) {
        this.exciseTax = exciseTax;
    }
     ...
     * @return totalStatus
     */
    public is.idega.webservice.vehicleregistryservice.client.TotalStatus getTotalStatus() {
        return totalStatus;
    }
     ...
     * @param totalStatus
     */
    public void setTotalStatus(is.idega.webservice.vehicleregistryservice.client.TotalStatus totalStatus) {
        this.totalStatus = totalStatus;
    }
     ...
     * @return alestrar
     */
    public is.idega.webservice.vehicleregistryservice.client.Reading[] getAlestrar() {
        return alestrar;
    }
     ...
     * @param alestrar
     */
    public void setAlestrar(is.idega.webservice.vehicleregistryservice.client.Reading[] alestrar) {
        this.alestrar = alestrar;
    }
     ...
     */
    public is.idega.webservice.vehicleregistryservice.client.EstimatedAutomobileTax getEstimatedAutomobileTaxes() {
        return estimatedAutomobileTaxes;
    }
     ...
     */
    public void setEstimatedAutomobileTaxes(is.idega.webservice.vehicleregistryservice.client.EstimatedAutomobileTax estimatedAutomobileTaxes) {
        this.estimatedAutomobileTaxes = estimatedAutomobileTaxes;
    }
