...
public class Accidents  implements java.io.Serializable {
    ...
    private is.idega.webservice.vehicleregistryservice.client.Accident[] accident;
    ...
    public Accidents(
           ...
           is.idega.webservice.vehicleregistryservice.client.Accident[] accident) {
     ...
     * @return accident
     */
    public is.idega.webservice.vehicleregistryservice.client.Accident[] getAccident() {
        return accident;
    }
     ...
     * @param accident
     */
    public void setAccident(is.idega.webservice.vehicleregistryservice.client.Accident[] accident) {
        this.accident = accident;
    }
