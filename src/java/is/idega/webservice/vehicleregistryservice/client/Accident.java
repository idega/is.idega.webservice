...
public class Accident  implements java.io.Serializable {
    ...
    private is.idega.webservice.vehicleregistryservice.client.Impacts[] impacts;

    private is.idega.webservice.vehicleregistryservice.client.AccidentVehicle[] otherVehiclesInAccident;
    ...
    public Accident(
           ...
           is.idega.webservice.vehicleregistryservice.client.Impacts[] impacts,
           is.idega.webservice.vehicleregistryservice.client.AccidentVehicle[] otherVehiclesInAccident) {
     ...
     * @return impacts
     */
    public is.idega.webservice.vehicleregistryservice.client.Impacts[] getImpacts() {
        return impacts;
    }
     ...
     * @param impacts
     */
    public void setImpacts(is.idega.webservice.vehicleregistryservice.client.Impacts[] impacts) {
        this.impacts = impacts;
    }
     ...
     */
    public is.idega.webservice.vehicleregistryservice.client.AccidentVehicle[] getOtherVehiclesInAccident() {
        return otherVehiclesInAccident;
    }
     ...
     */
    public void setOtherVehiclesInAccident(is.idega.webservice.vehicleregistryservice.client.AccidentVehicle[] otherVehiclesInAccident) {
        this.otherVehiclesInAccident = otherVehiclesInAccident;
    }
